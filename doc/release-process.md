...
##perform gitian builds
 ...
 Build monetad and moneta-qt on Linux32, Linux64, and Win32:
	...
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../moneta/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	...
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../moneta/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r moneta-${VERSION}-win-gitian.zip *
	mv moneta-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit moneta=v${VERSION} ../moneta/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
