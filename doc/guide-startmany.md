...
[From the moneta github repo](https://github.com/darkcoin/darkcoin/blob/master/doc/masternode_conf.md)
...
## What about the moneta.conf file?

If you are using a masternode.conf file you no longer need the moneta.conf file. The exception is if you need custom settings (thanks oblox). 

## Update moneta.conf on server

If you generated a new masternode private key, you will need to update the remote moneta.conf files.

Shut down the daemon and then edit the file.

```sudo nano .moneta/moneta.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote moneta.conf file.
...
And compare with the official explorer at http://explorer.moneta.io/chain/Moneta
