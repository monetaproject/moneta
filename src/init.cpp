...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: moneta.conf)") + "\n";
    if (hmm == HMM_BITCOIND)
    {
#if !defined(WIN32)
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: monetad.pid)") + "\n";
    ...
    strUsage += "  -anonymizemonetaamount=<n> " + _("Keep N moneta anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeDarkcoinAmount = GetArg("-anonymizemonetaamount", 0);
    ...
    LogPrintf("Anonymize Moneta Amount %d\n", nAnonymizeDarkcoinAmount);
