...
/* *** BEGIN DARKSEND MAGIC - DASH **********
    Copyright (c) 2014-2015, Moneta Developers
        eduffield - evan@moneta.io
        udjinm6   - udjinm6@moneta.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Moneta and make it unusable. To
