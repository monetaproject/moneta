...
QString BitcoinUnits::description(int unit)
{
    if(!TestNet() && !RegTest())
    {
        switch(unit)
        {
            case DASH: return QString("Moneta");
            case mDASH: return QString("Milli-Moneta (1 / 1,000)");
            case uDASH: return QString("Micro-Moneta (1 / 1,000,000)");
            case duffs: return QString("Ten Nano-Moneta (1 / 100,000,000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case DASH: return QString("TestMonetas");
            case mDASH: return QString("Milli-TestMoneta (1 / 1,000)");
            case uDASH: return QString("Micro-TestMoneta (1 / 1,000,000)");
            case duffs: return QString("Ten Nano-TestMoneta (1 / 100,000,000)");
            default: return QString("???");
        }
    }
}
